...
class Settings(BaseSettings):
    ...
    # Склейка входящих. Клиент Telegram режет длинное сообщение на несколько, и
    # они прилетают порознь. Ждём паузу после последнего куска и отправляем всё
    # одним ходом — иначе на каждый кусок пришёл бы отдельный ответ.
    coalesce_delay_s: float = 0.8
